  ...
  async function fetchTickers() {
    try {
      const [niftyRes, sensexRes, relianceRes] = await Promise.all([
        fetch('https://traders-paradise-3.onrender.com/yahoo-finance/chart/%5ENSEI'),
        fetch('https://traders-paradise-3.onrender.com/yahoo-finance/chart/%5EBSESN'),
        fetch('https://traders-paradise-3.onrender.com/yahoo-finance/chart/RELIANCE.NS'),
      ]);
